...
public class DataProvider_ExceMultiple {
	WebDriver driver;
 ...
 Object [][] data= new Object[1][1];
	  ...
	  data[0][0]=ExcelRevertMultiple.getCellData("Registration", 0, 0);
	  data[0][1]=ExcelRevertMultiple.getCellData("Registration", 0, 1);
